...
import { Erc20BlockchainFacade } from '../../api-provider/erc20-tokens/Erc20BlockchainFacade'
...
import { CryptoAddress, BlockchainFacade, Transaction } from '../../api-provider'
...
export abstract class ERC20TokenCurrencyGatewaySkeleton implements OnChainCurrencyGateway {
  ...
  private readonly erc20BlockchainFacade: BlockchainFacade
