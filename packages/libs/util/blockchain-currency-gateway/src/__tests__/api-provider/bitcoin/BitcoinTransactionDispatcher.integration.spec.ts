import { CryptoApisProviderProxy, ENetworkTypes } from '../../../api-provider/providers/crypto-apis'
...
describe.skip('BitcoinTransactionDispatcher:integration', () => {
  ...
  it('createTransaction', async () => {
    try {
      const cryptoApiProxy = new CryptoApisProviderProxy(CurrencyCode.bitcoin, ENetworkTypes.TESTNET, '99fd56a51dcdf7e069402d68f605fad34d656301')
