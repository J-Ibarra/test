...
export abstract class ERC20Gateway implements OnChainCurrencyGateway {
  logger: Logger
  web3: Web3
  contract: Contract
  ticker: CurrencyCode
  GAS_LIMIT: number = 80000
  ...
  constructor(env: Environment) {
    ...
    this.logger = Logger.getInstance('currencies', this.ticker.toLocaleLowerCase())
  }
  ...
  transferToExchangeHoldingsFrom(_fromAddress: CryptoAddress | Pick<CryptoAddress, 'privateKey'>, _amount: number): Promise<TransactionResponse> {
    throw new Error('Not supported')
  }
