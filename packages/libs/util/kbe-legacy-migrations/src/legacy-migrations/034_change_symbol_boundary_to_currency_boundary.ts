...
const currencyBoundaryValues = [
  { currencyId: 4, currencyCode: 'KVT', minAmount: 1, maxDecimals: 0 },
  { currencyId: 5, currencyCode: 'USD', minAmount: 0.01, maxDecimals: 2 },
  { currencyId: 6, currencyCode: 'EUR', minAmount: 0.01, maxDecimals: 2 },
  { currencyId: 2, currencyCode: 'KAU', minAmount: 0.00001, maxDecimals: 5 },
  { currencyId: 3, currencyCode: 'KAG', minAmount: 0.00001, maxDecimals: 5 },
  { currencyId: 1, currencyCode: 'ETH', minAmount: 0.000001, maxDecimals: 6 },
]
...
function insertCurrencyBoundaryValues(rows: Array<{ currencyId: number; currencyCode: string; minAmount: number; maxDecimals: number }>) {
  return rows
    .map(
      ({ currencyId, currencyCode, minAmount, maxDecimals }) =>
