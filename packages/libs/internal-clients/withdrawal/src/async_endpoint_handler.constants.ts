...
export const WITHDRAWAL_STATUS_CHANGE_QUEUE_URL = process.env.WITHDRAWAL_STATUS_CHANGE_QUEUE_URL
export const WITHDRAWAL_COMPLETED_QUEUE_URL = process.env.WITHDRAWAL_COMPLETED_QUEUE_URL
