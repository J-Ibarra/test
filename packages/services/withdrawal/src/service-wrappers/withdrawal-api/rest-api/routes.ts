...
export function RegisterRoutes(app: express.Express) {
  app.post('/api/withdrawals', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/withdrawals/configs', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.get('/api/withdrawals/configs/:currency', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.get('/api/crypto/validate', authenticateMiddleware([{ cookieAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/contacts/:currencyCode', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.post('/api/contacts', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
      request: { in: 'request', name: 'request', required: true, dataType: 'object' },
