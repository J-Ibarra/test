...
export function RegisterRoutes(app: express.Express) {
  app.get('/api/orders', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/orders/:orderId', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/orders/currencies/:currency', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.get('/api/fees/trade', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {}
  ...
  app.get('/api/fees/account', authenticateMiddleware([{ cookieAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
      request: { in: 'request', name: 'request', required: true, dataType: 'object' },
    }
  ...
  app.get('/api/fees/:symbolId', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
      request: { in: 'request', name: 'request', required: true, dataType: 'object' },
  ...
  app.post('/api/admin/fees/default', authenticateMiddleware([{ cookieAuth: [], adminAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/admin/fees/default', authenticateMiddleware([{ cookieAuth: [], adminAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.post('/api/admin/fees/account', authenticateMiddleware([{ cookieAuth: [], adminAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/admin/fees/account', authenticateMiddleware([{ cookieAuth: [], adminAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/order-matches', function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/admin/orders', authenticateMiddleware([{ adminAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {}
  ...
  app.get('/api/admin/orders/accounts/:accountHin', authenticateMiddleware([{ adminAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/transaction-history/:selectedCurrency', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.get('/api/depth/:symbolId/:direction/top', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.get('/api/depth/:symbolId', function(request: any, response: any, next: any) {
    const args = {
      symbolId: { in: 'path', name: 'symbolId', required: true, dataType: 'string' },
  ...
  app.post('/api/test-automation/orders/data-reset', function(request: any, response: any, next: any) {
    const args = {}
  ...
  app.post('/api/test-automation/orders/account-setup-scripts', function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/fee-pools', function(request: any, response: any, next: any) {
    const args = {}
  ...
  app.get('/api/fee-pools/:currencyCode', function(request: any, response: any, next: any) {
    const args = {
