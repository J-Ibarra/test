...
import { PLACE_ORDER_FACADE_TOKEN, ExchangePlaceOrderFacade } from '../../shared-components/providers'
...
export class TopUpRecorder {
  ...
  constructor(
    ...
    private placeOrderFacade: ExchangePlaceOrderFacade,
  ) {}
  ...
  async recordTopUpRequest(
    ...
    try {
      ...
      const topUpRequest = await this.topUpRequestRepository.createTopUpRequest(
        debitCard,
        orderId,
        amount,
        currency,
