...
import { AdminRequestStatus, AdminRequestType } from '../../admin-fund-management/interface'

export async function up({ sequelize }: { sequelize: Sequelize }) {
  return sequelize.query(`
    CREATE TYPE admin_request_type AS enum(
      '${AdminRequestType.deposit}', '${AdminRequestType.redemption}', '${
    AdminRequestType.withdrawal
  }');

    CREATE TYPE admin_status_type AS enum(
      '${AdminRequestStatus.approved}', '${AdminRequestStatus.pending}', '${
