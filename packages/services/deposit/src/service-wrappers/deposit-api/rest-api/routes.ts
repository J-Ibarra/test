...
export function RegisterRoutes(app: express.Express) {
  app.post('/api/vault', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
  ...
  app.get('/api/vault', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
      request: { in: 'request', name: 'request', required: true, dataType: 'object' },
    }
  ...
  app.get('/api/wallets', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(request: any, response: any, next: any) {
    const args = {
      request: { in: 'request', name: 'request', required: true, dataType: 'object' },
    }
  ...
  app.post('/api/wallets/address/activation', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
  ...
  app.get('/api/wallets/kinesis-bank-details', authenticateMiddleware([{ cookieAuth: [] }, { tokenAuth: [] }]), function(
    request: any,
    response: any,
    next: any,
  ) {
