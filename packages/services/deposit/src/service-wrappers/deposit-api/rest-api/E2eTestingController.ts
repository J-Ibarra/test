...
export class E2eTestingController {
  ...
  private currencyManager = new CurrencyManager(getEnvironment(), [CurrencyCode.kau, CurrencyCode.kag, CurrencyCode.kvt, CurrencyCode.ethereum, CurrencyCode.tether])
