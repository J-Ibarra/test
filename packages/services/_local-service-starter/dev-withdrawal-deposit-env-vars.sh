...
export KINESIS_BITCOIN_HOLDINGS_WIF='cRnFoP4ppGkJYq2RqDyV1sTV1VELQJqrh7JicDHKsya9TteoZu6E'
export KINESIS_BITCOIN_HOLDINGS_ADDRESS='miyMQRGRXMjbA5JbkC8sJPZk7CNz2XJUCK'
export KINESIS_BITCOIN_HOLDINGS_PRIVATE_KEY='7d4b27ec85a57b062ac6f8e6fc56b0530f42d1f7aa4256c5f6abf4a5561fbd46'
export BITCOIN_TRANSACTION_CONFIRMATION_BLOCKS=1
export AWS_PROFILE='kinesis'

export DEPOSIT_ADDRESS_TRANSACTION_CALLBACK_URL="https://integration-api.kinesis.money/api/webhooks/crypto/deposits/address/transactions"
export DEPOSIT_ADDRESS_TRANSACTION_QUEUE_URL='https://sqs.ap-southeast-2.amazonaws.com/884998542479/int-kbe-deposits-address-transactions'
